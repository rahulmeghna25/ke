...
db = client['Kamisama']
users_collection = db['RAHL']
settings_collection = db['settings0']  # A new collection to store global settings
redeem_codes_collection = db['redeem_codes0']

# Bot Configuration
TELEGRAM_BOT_TOKEN = '7854325693:AAEav3Y-C0OhpZn0A-Yea4oZgKHPqkCdUE4'
ADMIN_USER_ID = 7962308718  # Replace with your admin user ID
